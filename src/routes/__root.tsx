...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Divakar Tea Shop — Shop Manager" },
      { property: "og:description", content: "Fast, mobile-first business manager for Divakar Tea Shop." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "Divakar Tea" },
    ],
    links: [
